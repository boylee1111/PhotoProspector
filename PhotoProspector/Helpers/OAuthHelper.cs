...
namespace PhotoProspector.Helpers
{
    public class OAuthHelper
    {
        ...
        {
            TokenService = new Uri(tokenService);
            ClientId = clientId;
        ...
        internal static OAuthHelper HelperForService(string service, string redirectUri)
        {
            if (service == "business")
            {
                return new OAuthHelper(ConfigurationManager.AppSettings["pi:AADTokenService"],
                    ConfigurationManager.AppSettings["pi:AADAppId"],
                    ConfigurationManager.AppSettings["pi:AADAppSecret"],
                    redirectUri)
                {
            ...
            {
                return new OAuthHelper(ConfigurationManager.AppSettings["pi:MSATokenService"],
                    ConfigurationManager.AppSettings["pi:MSAAppId"],
                    ConfigurationManager.AppSettings["pi:MSAAppSecret"],
                    redirectUri)
                {
